...
- Optimizing performance, bundle size, or data fetching
- Reviewing React/Next.js code for performance issues
- Refactoring existing React/Next.js code
- Building new React components or Next.js pages

**❌ Do NOT use this skill when:**
- Working on Shopify Liquid themes (`.liquid` files)
- Building Vue.js, Angular, or Svelte applications
- Working on backend-only projects without UI
- Building plain HTML/CSS/JavaScript sites without React
